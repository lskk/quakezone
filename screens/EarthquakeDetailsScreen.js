        ...
        return (
            <View>
                ...
                <View style={styles.container}>
                    <Text style={{color:"white",fontSize:18,fontWeight:"bold",textAlign: 'center'}}>Earthquake Details</Text>
                </View>
                <View style={{ marginLeft: 7 }}>
                    <View >
                        <View style={styles.rowContainer}>
                            ...
                            <View style={{ height: "50%", width: "78%", borderBottomColor: "black", borderBottomWidth: 2 }}></View>
                        </View>
                        <View style={styles.subTextContainer}>
                            <Text style={styles.subText}>Epicenter : Makkasaar , Indonesia</Text>
                    ...
                    <View>
                        <View style={styles.rowContainer}>
                            ...
                            <View style={{ height: "50%", width: "88%", borderBottomColor: "black", borderBottomWidth: 2 }}></View>
                        </View>
                        <View style={styles.subTextContainer}>
                    ...
                    <View>
                        <View style={styles.rowContainer}>
                            ...
                            <View style={{ height: "50%", width: "74%", borderBottomColor: "black", borderBottomWidth: 2 }}></View>
                        </View>
                        <View style={styles.subTextContainer}>
                    ...
                    <View>
                        <View style={styles.rowContainer}>
                            ...
                            <View style={{ height: "50%", width: "85%", borderBottomColor: "black", borderBottomWidth: 2 }}></View>
                    ...
                    <View>
                        <View style={styles.rowContainer}>
                            ...
                            <View style={{ height: "50%", width: "75%", borderBottomColor: "black", borderBottomWidth: 2 }}></View>
                        </View>
                        <View style={styles.subTextContainer}>
                    ...
                    <View>
                        <View style={styles.rowContainer}>
                            ...
                            <View style={{ height: "50%", width: "55%", borderBottomColor: "black", borderBottomWidth: 2 }}></View>
                        </View>
                        <View>
