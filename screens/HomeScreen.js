        ...
        return (
            <View>
                <View style={styles.Fourty}>
                    ...
                    <View style={styles.overlayFirst}>
                        <View style={styles.TempWeather}>
                            <Image source={require("../assets/rain.png")} style={{ marginBottom: 7, height: "50%", width: "50%" }} />
                ...
                <View style={styles.Twenty}>
                    <Image source={require("../assets/kolkata-map.jpg")} style={{ width: "100%", height: "100%" }} />
                    <View style={styles.overlayMiddle}>
                        <View style={styles.InnerMiddle}>
                            <Text style={styles.MiddleText}>Tectonik earthquae just happened 5M </Text>
